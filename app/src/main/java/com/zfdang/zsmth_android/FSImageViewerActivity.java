...
public class FSImageViewerActivity extends AppCompatActivity implements OnPhotoTapListener, OnOutsidePhotoTapListener {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        // Prefetch all images to ensure they're cached
        prefetchImages();
    ...
    private void prefetchImages() {
        // Give a small delay before prefetching to ensure ViewPager is ready
            ...
            for (String url : mURLs) {
                try {
                    ...
                    ImageRequest request = ImageRequestBuilder.newBuilderWithSource(uri)
                            ...
                            .build();
                    DataSource<Void> prefetchSource = imagePipeline.prefetchToDiskCache(request, this);
                    // Don't need to handle result, just prefetch
                } catch (Exception e) {
                    Log.e(TAG, "Failed to prefetch image: " + url, e);
                }
            }
        }, 500);
    }
    ...
    public void saveImageToFile(String imagePath, boolean isAnimation) {
        File imageFile = FrescoUtils.getCachedImageOnDisk(FSImageViewerActivity.this,Uri.parse(imagePath));
        // Fallback: Try alternative cache locations or methods
        if (imageFile == null) {
